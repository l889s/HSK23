...
type ToastVariant = "success" | "info" | "error" | "violet";
        ...
        {toasts.map((t) => {
          ...
          return (
            <div
              key={t.id}
              className={cn(
                "pointer-events-auto flex w-full items-center gap-2.5 rounded-2xl px-4 py-3 shadow-cardHover animate-in fade-in slide-in-from-top-2",
                STYLES[t.variant]
              )}
              role="status"
            >
