...
export function ReviewContext({
  ...
  if (isNew) {
    return (
      <div className="mx-auto mb-3 w-full max-w-md rounded-2xl border border-mint/20 bg-mint-soft/50 px-4 py-2.5">
  ...
  return (
    <div className="mx-auto mb-3 w-full max-w-md rounded-2xl border border-[#E8E8E8] bg-[#FAFAFA] px-4 py-2.5">
