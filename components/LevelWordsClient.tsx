  ...
  return (
    <>
      ...
      >
        <Link
          href="/hsk-levels"
          className="flex items-center gap-1.5 rounded-xl border border-white/20 bg-white/15 px-3.5 py-1.5 text-sm font-bold text-white hover:bg-white/25"
        >
      ...
      <div className="mx-auto max-w-2xl px-4 py-5 sm:px-5">
        ...
        <div className="mb-5">
          <h2 className="mb-1.5 text-2xl font-extrabold text-ink">
            {level.label} <span className="font-cn text-base text-muted">— {level.cn}</span>
          </h2>
        ...
        <div className="flex flex-col gap-3.5">
          ...
          {filtered.map((w, i) => (
            ...
            >
              ...
              {/* المعنى */}
              <div
                className="my-3 rounded-xl px-3 py-2.5 text-right text-sm font-bold text-ink"
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={() => play(w.s)}
                  className="flex flex-1 items-center justify-center gap-1.5 rounded-xl bg-[#F7F7F7] py-2.5 text-[13px] font-bold text-muted hover:bg-[#EEEEEE]"
                >
                  <Volume2 className="h-3.5 w-3.5" />
                  الجملة
                </button>
